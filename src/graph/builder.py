...
def build_graph():
    """
    Build the agent using create_agent() instead of manually wiring
    StateGraph nodes/edges and calling model.bind_tools() ourselves.

    create_agent() internally handles:
      - binding tools to the model
      - the agent -> tools -> agent loop
      - deciding when to stop and return the final answer
    """
